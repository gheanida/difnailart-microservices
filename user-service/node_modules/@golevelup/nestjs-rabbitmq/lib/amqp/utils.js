...
exports.assertRabbitMqUri = exports.matchesRoutingKey = void 0;
 ...
 * @returns
 */
const assertRabbitMqUri = (uri) => {
    if (Array.isArray(uri)) {
        for (const u of uri) {
            (0, exports.assertRabbitMqUri)(u);
        }
        return;
    }
...
exports.assertRabbitMqUri = assertRabbitMqUri;
